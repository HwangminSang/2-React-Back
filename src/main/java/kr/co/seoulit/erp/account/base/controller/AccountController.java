...
public ResponseEntity<HashMap<String, Object>> getLedgerbyAccountInfo(@PathVariable String accountCode,
	...
	//=====================================  2020-11-28 계정과목관리 유길현 시작  ==================================
	   ...
	   //계정과목관리 삭제
	   @RequestMapping(value="/account/deleteAccountList")
	   public void deleteAccountList(@RequestParam String accountInnerCode) {
		   System.out.println("  ::::::: 계정과목관리 삭제   :::::::  "+ accountInnerCode);
		   accountServiceFacade.deleteAccountList(accountInnerCode);
	   }
	   
	   // 계정과목관리 저장
	   @RequestMapping(value="/account/batchAccountList", method = RequestMethod.POST) 
	   public void batchAccountList(@RequestBody HashMap<String, ArrayList<AccountBean>> accountList) {
		   System.out.println("  ::::::: 계정과목관리 저장   :::::::  "+ accountList);
		   accountServiceFacade.batchAccountList(accountList);
	   }
	   //=====================================  2020-11-28 계정과목관리 유길현 시작  ==================================   
}