...
//		String mpsNoListStr = request.getParameter("mpsNoList");
	...
	@RequestMapping(value = "/getMrpGatheringList", method = RequestMethod.PUT)
	@SuppressWarnings("unchecked")
	public ModelMap getMrpGatheringList(@RequestBody Map<String, Object> params) {
		Object mrpNoList = params.get("mrpNoList");
		ArrayList<MrpGatheringTO> mrpNoArr = (ArrayList<MrpGatheringTO>) mrpNoList;
